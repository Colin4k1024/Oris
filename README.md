...
| Experience Repository | `crates/oris-experience-repo` | v0.4.0 — governed MCP bridge for Claude Code, OpenCode, Codex, and Grok; Ed25519 PKI and rate limiting | standalone crate |
