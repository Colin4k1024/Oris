...
| #76 | partially implemented | the governor already supports success-threshold promotion, blast-radius caps, replay-failure revocation, and a promotion cooling window, but it does not yet implement time-window rate limits or confidence decay/history. |
